...
!
  ...
  TYPE, PUBLIC :: DgnState
     ...
     REAL(f4),  POINTER :: AerMassSO4b     (:,:,:  ) ! Sulfate [ug/m3] ! UAJ
     ...
     LOGICAL :: Archive_AerMassSO4b ! UAJ
     ...
     REAL(f4),  POINTER :: ProdSO2bfromDMSandOH        (:,:,:)
     REAL(f4),  POINTER :: ProdSO2bfromDMSandNO3       (:,:,:)
     REAL(f4),  POINTER :: ProdSO2bfromDMS             (:,:,:)
     REAL(f4),  POINTER :: ProdMSAfromDMS             (:,:,:)
     REAL(f4),  POINTER :: ProdNITfromHNO3uptakeOnDust(:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromGasPhase        (:,:,:) ! UAJ
     REAL(f4),  POINTER :: ProdSO4bfromGasPhase        (:,:,:) 
     REAL(f4),  POINTER :: ProdSO4fromH2O2inCloud     (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromH2O2inCloud     (:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromO3inCloud       (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromO3inCloud       (:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromO2inCloudMetal  (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromO2inCloudMetal  (:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromO3inSeaSalt     (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromO3inSeaSalt     (:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromOxidationOnDust (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromOxidationOnDust (:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromUptakeOfH2SO4g  (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromUptakeOfH2SO4g  (:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromHOBrInCloud     (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromHOBrInCloud     (:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromSRO3            (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromSRO3            (:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromSRHOBr          (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromSRHOBr          (:,:,:)
     REAL(f4),  POINTER :: ProdSO4fromO3s             (:,:,:)
     REAL(f4),  POINTER :: ProdSO4bfromO3s             (:,:,:)
     REAL(f4),  POINTER :: LossHNO3onSeaSalt          (:,:,:)
     LOGICAL :: Archive_ProdSO2bfromDMSandOH
     LOGICAL :: Archive_ProdSO2bfromDMSandNO3
     LOGICAL :: Archive_ProdSO2bfromDMS
     LOGICAL :: Archive_ProdMSAfromDMS
     LOGICAL :: Archive_ProdNITfromHNO3uptakeOnDust
     LOGICAL :: Archive_ProdSO4fromGasPhase
     LOGICAL :: Archive_ProdSO4bfromGasPhase
     LOGICAL :: Archive_ProdSO4fromH2O2inCloud
     LOGICAL :: Archive_ProdSO4bfromH2O2inCloud
     LOGICAL :: Archive_ProdSO4fromO3inCloud
     LOGICAL :: Archive_ProdSO4bfromO3inCloud
     LOGICAL :: Archive_ProdSO4fromO2inCloudMetal
     LOGICAL :: Archive_ProdSO4bfromO2inCloudMetal
     LOGICAL :: Archive_ProdSO4fromO3inSeaSalt
     LOGICAL :: Archive_ProdSO4bfromO3inSeaSalt
     LOGICAL :: Archive_ProdSO4fromOxidationOnDust
     LOGICAL :: Archive_ProdSO4bfromOxidationOnDust
     LOGICAL :: Archive_ProdSO4fromUptakeOfH2SO4g
     LOGICAL :: Archive_ProdSO4bfromUptakeOfH2SO4g
     LOGICAL :: Archive_ProdSO4fromHOBrInCloud
     LOGICAL :: Archive_ProdSO4bfromHOBrInCloud
     LOGICAL :: Archive_ProdSO4fromSRO3
     LOGICAL :: Archive_ProdSO4bfromSRO3
     LOGICAL :: Archive_ProdSO4fromSRHOBr
     LOGICAL :: Archive_ProdSO4bfromSRHOBr
     LOGICAL :: Archive_ProdSO4fromO3s
     LOGICAL :: Archive_ProdSO4bfromO3s
     ...
     INTEGER,             POINTER :: ObsPack_curtain      (:  )
     ...
     REAL(f4),            POINTER :: ObsPack_TO3          (:  )
     REAL(f4),            POINTER :: ObsPack_CLDF         (:  )
     REAL(f4),            POINTER :: ObsPack_CLDFRC       (:  )
     REAL(f4),            POINTER :: ObsPack_ALBD         (:  )
     REAL(f4),            POINTER :: ObsPack_LWI          (:  )
     REAL(f4),            POINTER :: ObsPack_BXHGHT       (:  )
     REAL(f4),            POINTER :: ObsPack_PSFC         (:  )
     REAL(f4),            POINTER :: ObsPack_RELH         (:  )
     REAL(f4),            POINTER :: ObsPack_ODAERTOT     (:  )

     INTEGER,             POINTER :: ObsPack_nLev         (:  )
     ...
     ! ObsPack photolysis reactions and metadata variables
     INTEGER                      :: ObsPack_nPhotol
     REAL(f4),            POINTER :: ObsPack_jval         (:,:)
     INTEGER,             POINTER :: ObsPack_jval_Ind     (:  )
     CHARACTER(LEN=31 ),  POINTER :: ObsPack_jval_Name    (:  )
     CHARACTER(LEN=80 ),  POINTER :: ObsPack_jval_LName   (:  )

    ! ObsPack aerosol optical depths and metadata variables
    INTEGER                      :: ObsPack_nODAER
    REAL(f4),            POINTER :: ObsPack_ODAER         (:,:)
    INTEGER,             POINTER :: ObsPack_ODAER_Ind     (:  )
    CHARACTER(LEN=31 ),  POINTER :: ObsPack_ODAER_Name    (:  )
    CHARACTER(LEN=80 ),  POINTER :: ObsPack_ODAER_LName   (:  )
...
!
    ...
    State_Diag%AerMassSO4b                         => NULL() ! UAJ
    ...
    State_Diag%Archive_AerMassSO4b                 = .FALSE. ! UAJ
    ...
    State_Diag%ProdSO2bfromDMSandOH                 => NULL()
    State_Diag%ProdSO2bfromDMSandNO3                => NULL()
    State_Diag%ProdSO2bfromDMS                      => NULL()
    ...
    State_Diag%ProdSO4bfromGasPhase                 => NULL() ! UAJ
    State_Diag%ProdSO4bfromH2O2inCloud              => NULL() ! UAJ
    State_Diag%ProdSO4bfromO3inCloud                => NULL() ! UAJ
    State_Diag%ProdSO4bfromO2inCloudMetal           => NULL() ! UAJ
    State_Diag%ProdSO4bfromO3inSeaSalt              => NULL() ! UAJ
    State_Diag%ProdSO4bfromOxidationOnDust          => NULL() ! UAJ
    State_Diag%ProdSO4bfromUptakeOfH2SO4g           => NULL() ! UAJ
    State_Diag%ProdSO4bfromHOBrInCloud              => NULL() ! UAJ
    State_Diag%ProdSO4bfromSRO3                     => NULL() ! UAJ
    State_Diag%ProdSO4bfromSRHOBr                   => NULL() ! UAJ
    State_Diag%ProdSO4bfromO3s                      => NULL() ! UAJ
    State_Diag%LossHNO3onSeaSalt                   => NULL()
    State_Diag%Archive_ProdSO2bfromDMSandOH         = .FALSE.
    State_Diag%Archive_ProdSO2bfromDMSandNO3        = .FALSE.
    State_Diag%Archive_ProdSO2bfromDMS              = .FALSE.
    ...
    State_Diag%Archive_ProdSO4bfromGasPhase         = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromH2O2inCloud      = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromO3inCloud        = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromO2inCloudMetal   = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromO3inSeaSalt      = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromOxidationOnDust  = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromUptakeOfH2SO4g   = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromHOBrInCloud      = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromSRO3             = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromSRHOBr           = .FALSE. ! UAJ
    State_Diag%Archive_ProdSO4bfromO3s              = .FALSE. ! UAJ
    ...
    State_Diag%ObsPack_curtain                     => NULL()
    ...
    State_Diag%ObsPack_TO3                         => NULL()
    State_Diag%ObsPack_CLDF                        => NULL()
    State_Diag%ObsPack_CLDFRC                      => NULL()
    State_Diag%ObsPack_ALBD                        => NULL()
    State_Diag%ObsPack_LWI                         => NULL()
    State_Diag%ObsPack_BXHGHT                      => NULL()
    State_Diag%ObsPack_PSFC                        => NULL()
    State_Diag%ObsPack_RELH                        => NULL()
    State_Diag%ObsPack_ODAERTOT                    => NULL()
    State_Diag%ObsPack_nLev                        => NULL()
    ...
    State_Diag%ObsPack_nPhotol                     =  0
    State_Diag%ObsPack_jval                        => NULL()
    State_Diag%ObsPack_jval_Ind                    => NULL()
    State_Diag%ObsPack_jval_Name                   => NULL()
    State_Diag%ObsPack_jval_LName                  => NULL()
    State_Diag%ObsPack_nODAER                      =  0
    State_Diag%ObsPack_ODAER                       => NULL()
    State_Diag%ObsPack_ODAER_Ind                   => NULL()
    State_Diag%ObsPack_ODAER_Name                  => NULL()
    State_Diag%ObsPack_ODAER_LName                 => NULL()
 ...
 10 FORMAT( /, 'Allocating the following fields of the State_Diag object:' )
    ...
    IF ( Input_Opt%ITS_A_FULLCHEM_SIM ) THEN
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b by aqueous oxidation of HOBr in cloud   ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromHOBrInCloud'
       diagID  = 'ProdSO4bfromHOBrInCloud'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromHOBrInCloud( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromHOBrInCloud = 0.0_f4
          State_Diag%Archive_ProdSO4bfromHOBrInCloud = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromHOBrInCloud,       &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b by SRHOBr               ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromSRHOBr'
       diagID  = 'ProdSO4bfromSRHOBr'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromSRHOBr( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromSRHOBr = 0.0_f4
          State_Diag%Archive_ProdSO4bfromSRHOBr = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromSRHOBr,            &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       DO N = 1, 34
          ...
          SELECT CASE( N )
             ...
             CASE( 32 )
                diagID = 'KppSmDecomps'
             CASE( 33 )
                diagID = 'ProdSO4bfromHOBrInCloud'  ! UAJ
             CASE( 34 )
                diagID = 'ProdSO4bfromSRHOBr'       ! UAJ
    ...
    IF ( Input_Opt%ITS_A_FULLCHEM_SIM .or. Input_Opt%ITS_AN_AEROSOL_SIM ) THEN
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b from aqueous oxidation of H2O2 in cloud   ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromH2O2inCloud'
       diagID  = 'ProdSO4bfromH2O2inCloud'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromH2O2inCloud( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromH2O2inCloud = 0.0_f4
          State_Diag%Archive_ProdSO4bfromH2O2inCloud = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromH2O2inCloud,       &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b from aqueous oxidation of O3 in cloud  ! UAJ 
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromO3inCloud'
       diagID  = 'ProdSO4bfromO3inCloud'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromO3inCloud( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromO3inCloud = 0.0_f4
          State_Diag%Archive_ProdSO4bfromO3inCloud = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromO3inCloud,         &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b from aqueous oxidation of O2 metal-catalyzed    ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromO2inCloudMetal'
       diagID  = 'ProdSO4bfromO2inCloudMetal'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromO2inCloudMetal(IM, JM, LM), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromO2inCloudMetal = 0.0_f4
          State_Diag%Archive_ProdSO4bfromO2inCloudMetal = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromO2inCloudMetal,    &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b from O3 in sea salt aerosols                  ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSo4bfromO3inSeaSalt'
       diagID  = 'ProdSo4bfromO3inSeaSalt'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE(6,20) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSo4bfromO3inSeaSalt( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSo4bfromO3inSeaSalt = 0.0_f4
          State_Diag%Archive_ProdSo4bfromO3inSeaSalt = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSo4bfromO3inSeaSalt,       &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b by SRO3                                         ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromSRO3'
       diagID  = 'ProdSO4bfromSRO3'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE(6,20) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromSRO3( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromSRO3 = 0.0_f4
          State_Diag%Archive_ProdSO4bfromSRO3 = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromSRO3,              &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b by O3s                                          ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromO3s'
       diagID  = 'ProdSO4bfromO3s'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromO3s( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromO3s = 0.0_f4
          State_Diag%Archive_ProdSO4bfromO3s = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromO3s,               &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       !-------------------------------------------------------------------
       ! Aerosol mass of SO4b [ug/m3]                                         ! UAJ
       !-------------------------------------------------------------------
       arrayID = 'State_Diag%AerMassSO4b'
       diagID  = 'AerMassSO4b'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%AerMassSO4b( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%AerMassSO4b = 0.0_f4
          State_Diag%Archive_AerMassSO4b = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%AerMassSO4b,                   &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
    ...
    IF ( Input_Opt%ITS_AN_AEROSOL_SIM ) THEN
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b in gas phase                                      ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromGasPhase'
       diagID  = 'ProdSO4bfromGasPhase'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromGasPhase( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromGasPhase = 0.0_f4
          State_Diag%Archive_ProdSO4bfromGasPhase = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromGasPhase,          &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       !--------------------------------------------------------------------
       ! Total production of SO2b from DMS                                    ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO2bfromDMS'
       diagID  = 'ProdSO2bfromDMS'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE(6,20) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO2bfromDMS( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO2bfromDMS = 0.0_f4
          State_Diag%Archive_ProdSO2bfromDMS = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO2bfromDMS,               &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF

       !--------------------------------------------------------------------
       ! Production of SO2b from DMS and NO3                                 ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO2bfromDMSandNO3'
       diagID  = 'ProdSO2bfromDMSandNO3'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE(6,20) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO2bfromDMSandNO3( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO2bfromDMSandNO3 = 0.0_f4
          State_Diag%Archive_ProdSO2bfromDMSandNO3 = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO2bfromDMSandNO3,         &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF

       !--------------------------------------------------------------------
       ! Production of SO2b from DMS and OH                                  ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO2bfromDMSandOH'
       diagID  = 'ProdSO2bfromDMSandOH'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE(6,20) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO2bfromDMSandOH( IM, JM, LM ), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO2bfromDMSandOH = 0.0_f4
          State_Diag%Archive_ProdSO2bfromDMSandOH = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO2bfromDMSandOH,          &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
    ...
    IF ( Input_Opt%ITS_A_FULLCHEM_SIM .and. Input_Opt%LDSTUP ) THEN
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b from oxidation on dust                         ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromOxidationOnDust'
       diagID  = 'ProdSO4bfromOxidationOnDust'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromOxidationOnDust(IM,JM,LM), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromOxidationOnDust = 0.0_f4
          State_Diag%Archive_ProdSO4bfromOxidationOnDust = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromOxidationOnDust,   &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
       ...
       !--------------------------------------------------------------------
       ! Production of SO4b from uptake of H2SO4(g)                     ! UAJ
       !--------------------------------------------------------------------
       arrayID = 'State_Diag%ProdSO4bfromUptakeOfH2SO4g'
       diagID  = 'ProdSO4bfromUptakeOfH2SO4g'
       CALL Check_DiagList( am_I_Root, Diag_List, diagID, Found, RC )
       IF ( Found ) THEN
          IF ( am_I_Root ) WRITE( 6, 20 ) ADJUSTL( arrayID ), TRIM( diagID )
          ALLOCATE( State_Diag%ProdSO4bfromUptakeOfH2SO4g(IM,JM,LM), STAT=RC )
          CALL GC_CheckVar( arrayID, 0, RC )
          IF ( RC /= GC_SUCCESS ) RETURN
          State_Diag%ProdSO4bfromUptakeOfH2SO4g = 0.0_f4
          State_Diag%Archive_ProdSO4bfromUptakeOfH2SO4g = .TRUE.
          CALL Register_DiagField( Input_Opt, diagID,                        &
                                   State_Diag%ProdSO4bfromUptakeOfH2SO4g,    &
                                   State_Chm, State_Diag, RC                )
          IF ( RC /= GC_SUCCESS ) RETURN
       ENDIF
...
20  FORMAT( 1x, a32, ' is registered as: ', a )
 ...
 30    FORMAT( /, &
    ...
    State_Diag%Archive_AerMass = ( State_Diag%Archive_AerMassASOA       .or. &
                                   ...
                                   State_Diag%Archive_AerMassSO4b       .or. & ! UAJ
...
!
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO2bfromDMSandOH ) ) THEN
       DEALLOCATE( State_Diag%ProdSO2bfromDMSandOH, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO2bfromDMSandOH', 2, RC )
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO2bfromDMSandOH => NULL()
    ENDIF

    IF ( ASSOCIATED( State_Diag%ProdSO2bfromDMSandNO3 ) ) THEN
       DEALLOCATE( State_Diag%ProdSO2bfromDMSandNO3, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO2bfromDMSandNO3', 2, RC )
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO2bfromDMSandNO3 => NULL()
    ENDIF

    IF ( ASSOCIATED( State_Diag%ProdSO2bfromDMS ) ) THEN
       DEALLOCATE(  State_Diag%ProdSO2bfromDMS, STAT=RC )
       CALL GC_CheckVar( ' State_Diag%ProdSO2bfromDMS', 2, RC )
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO2bfromDMS => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromGasPhase ) ) THEN
       DEALLOCATE( State_Diag%ProdSO4bfromGasPhase, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromGasPhase', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromGasPhase => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromH2O2inCloud ) ) THEN
       DEALLOCATE( State_Diag%ProdSO4bfromH2O2inCloud, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromH2O2inCloud', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromH2O2inCloud => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromO3inCloud ) ) THEN 
       DEALLOCATE( State_Diag%ProdSO4bfromO3inCloud, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromO3inCloud', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromO3inCloud => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromHOBrInCloud ) ) THEN
       DEALLOCATE( State_Diag%ProdSO4bfromHOBrInCloud, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromHOBrInCloud', 2, RC )  ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromHOBrInCloud => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromO2inCloudMetal ) ) THEN
       DEALLOCATE( State_Diag%ProdSO4bfromO2inCloudMetal, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromO2inCloudMetal', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromO2inCloudMetal => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromO3inSeaSalt ) ) THEN
        DEALLOCATE( State_Diag%ProdSO4bfromO3inSeaSalt, STAT=RC )
        CALL GC_CheckVar( 'State_Diag%ProdSO4bfromO3inSeaSalt', 2, RC ) ! UAJ
        IF ( RC /= GC_SUCCESS ) RETURN
        State_Diag%ProdSO4bfromO3inSeaSalt => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromOxidationOnDust  ) ) THEN
       DEALLOCATE( State_Diag%ProdSO4bfromOxidationOnDust, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromOxidationOnDust', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromOxidationOnDust => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromUptakeOfH2SO4g ) ) THEN
       DEALLOCATE( State_Diag%ProdSO4bfromUptakeOfH2SO4g, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromUptakeOfH2SO4g', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromUptakeOfH2SO4g => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromSRO3 ) ) THEN
       DEALLOCATE( State_Diag%ProdSO4bfromSRO3, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromSRO3', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromSRO3 => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromSRHOBr ) ) THEN
       DEALLOCATE( State_Diag%ProdSO4bfromSRHOBr, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromSRHOBr', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromSRHOBr => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%ProdSO4bfromO3s ) ) THEN
       DEALLOCATE( State_Diag%ProdSO4bfromO3s, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%ProdSO4bfromO3s', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%ProdSO4bfromO3s => NULL()
    ENDIF
    ...
    IF ( ASSOCIATED( State_Diag%AerMassSO4b ) ) THEN
       DEALLOCATE( State_Diag%AerMassSO4b, STAT=RC )
       CALL GC_CheckVar( 'State_Diag%AerMassSO4b', 2, RC ) ! UAJ
       IF ( RC /= GC_SUCCESS ) RETURN
       State_Diag%AerMassSO4b => NULL()
    ENDIF
...
!
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO2BFROMDMSANDOH' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO2 from DMS+OH reaction'
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3

    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO2BFROMDMSANDNO3' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO2 from DMS+NO3 reaction'
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3

    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO2BFROMDMS' ) THEN
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMGASPHASE' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from gas phase reactions' ! UAJ
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMH2O2INCLOUD' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from aqueous ' // & ! UAJ
                                'oxidation of H2O2 in clouds'
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMO3INCLOUD' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from aqueous ' // & ! UAJ
                                'oxidation of O3 in clouds'
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMHOBRINCLOUD' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from aqueous ' // &
                                'oxidation of HOBr in clouds'
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMO2INCLOUDMETAL' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from aqueous oxidation of O2 metal-catalyzed' ! UAJ
       IF ( isUnits   ) Units = 'kg S'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMO3INSEASALT' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from O3 in sea ' // & ! UAJ
                                'salt aerosols'
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMOXIDATIONONDUST' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from oxidation on ' // &
                                'dust aerosols'
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMUPTAKEOFH2SO4G' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from uptake of H2SO4(g)' ! UAJ
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMSRO3' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b by SRO3'    ! UAJ
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMSRHOBR' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from SRHOBr'    ! UAJ
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'PRODSO4BFROMO3S' ) THEN
       IF ( isDesc    ) Desc  = 'Production of SO4b from O3s'     ! UAJ
       IF ( isUnits   ) Units = 'kg S s-1'
       IF ( isRank    ) Rank  =  3
    ...
    ELSE IF ( TRIM( Name_AllCaps ) == 'AERMASSSO4B' ) THEN   ! UAJ
       IF ( isDesc    ) Desc  = 'Mass of sulfate aerosol'
       IF ( isUnits   ) Units = 'ug m-3'
       IF ( isRank    ) Rank  =  3
