...
!
    ...
    INTEGER, SAVE          :: id_SO4b
    INTEGER, SAVE          :: LASTMONTH = -99

    ! scalars
    INTEGER                :: I,    J,     L,    N
    REAL(fp)               :: ARH,  ATEMP, AVOL, SO4,  ASO4, ANO3
    REAL(fp)               :: SO4b, ASO4b, AHSO4b ! UAJ
    ...
    IF ( FIRST ) THEN
       ...
       IF ( id_SO4b == 0 ) CALL ERROR_STOP( 'id_SO4b is undefined!', X )
    ...
    !$OMP PARALLEL DO       &
    !$OMP DEFAULT( SHARED ) &
    !$OMP PRIVATE( I,    J,    L,    ATEMP, ARH,  AVOL,  SO4,SO4b  ) &
    !$OMP PRIVATE( ANH4, ANO3, GNH3, GNO3,  ASO4,ASO4b, AHSO4,AHSO4b, AH2O)
    ...
    DO I = 1, State_Grid%NX
       ...
       SO4b  = MAX( Spc(I,J,L,id_SO4b) * 1.e+9_fp / AVOL, CONMIN )
       ...
       !==============================================================
       CALL RPMARES( (SO4+SO4b),  GNO3,  GNH3, ARH,  ATEMP, &
                     (ASO4+ASO4b), (AHSO4+AHSO4b), ANO3, AH2O, ANH4 )
