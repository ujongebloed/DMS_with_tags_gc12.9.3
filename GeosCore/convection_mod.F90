...
!
    ...
    DO NA = 1, nAdvect
       ...
       !IF ( NA > 261 .and. NA < 264 ) THEN
        !       WRITE(*,*) "mean p_FSOL", NA, SUM(p_FSOL)/(MAX(1,SIZE(p_FSOL)))
       !ENDIF
...
!
    ...
    SO2sb     => State_Chm%SO2bAfterChem (I,J,:   ) ! SO2s from sulfate_mod ! UAJ
          ...
          DO K = CLDBASE-1, 1, -1
             ...
             IF ( PDOWN(K+1)  > 0 .and. &
                ...
                CALL WASHOUT( I,         J,                         &
                              K,         IC,         BXHEIGHT(K),   &
                              T(K),      QDOWN,      SDT,           &
                              F_WASHOUT, H2O2s(K),   SO2s(K),  SO2sb(K), & ! UAJ
