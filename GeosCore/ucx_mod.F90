...
!
  ...
  INTEGER :: id_OClO,    id_PAN,      id_SO2,  id_SO2b,  id_SO4, id_SO4b ! UAJ
...
!
    ...
    DO I = 1, State_Grid%NX
       ...
       ELSEIF ( State_Met%InTroposphere(I,J,L) ) THEN
          ...
          AERFRAC(I,J,L,1) = 1e+0_fp
       ELSE
          H2SO4SUM = (Spc(I,J,L,id_SO4)+Spc(I,J,L,id_SO4b)) * INVAIR &
                  / SO4_MW_G ! UAJ
...
!
    ...
    DO I = 1, State_Grid%NX
       ...
       H2SO4SUM = (Spc(I,J,L,id_SO4)+Spc(I,J,L,id_SO4b)) * INVAIR / & ! UAJ
...
!
    ...
    REAL(fp)              :: GMU,SO4_IN,SO4_INb, PHOTDELTA,DTCHEM ! UAJ
    REAL(fp)              :: SO2_MW_G, SO4_MW_g, SO4_DELTA, SO4_DELTAb ! UAJ
    LOGICAL               :: DAYCOLUMN
    INTEGER               :: LMINPHOT
    REAL(fp)              :: RELWT
    LOGICAL,SAVE          :: FIRST=.TRUE.
    ...
    DO I=1,State_Grid%NX
       ...
       IF (DAYCOLUMN) THEN
          ...
          DO L=LMINPHOT+1,State_Grid%NZ
             ...
             SO4_INb = Spc(I,J,L,id_SO4b)*SO4_PHOTFRAC(I,J,L) ! UAJ
             SO4_DELTA = PHOTDELTA*SO4_IN
             SO4_DELTAb = PHOTDELTA*SO4_INb ! UAJ
             ! Remove from SO4
             Spc(I,J,L,id_SO4) = Spc(I,J,L,id_SO4) - SO4_DELTA
             Spc(I,J,L,id_SO4b) = Spc(I,J,L,id_SO4b) - SO4_DELTAb ! UAJ
             ! Add to SO2. Note change in molar mass
             Spc(I,J,L,id_SO2) = Spc(I,J,L,id_SO2) + (SO4_DELTA*RELWT)
             Spc(I,J,L,id_SO2b) = Spc(I,J,L,id_SO2b) + (SO4_DELTAb*RELWT) ! UAJ
          ENDDO
...
!
    ...
    id_O3    = Ind_('O3'        )
    id_SO2   = Ind_('SO2'       )
    id_SO2b  = Ind_('SO2b'      ) ! UAJ
    id_SO4   = Ind_('SO4'       )
    id_SO4b  = Ind_('SO4b'      ) ! UAJ
...
300       FORMAT( a, ' ', a )
    ...
    ALLOCATE( AERFRACIND( 8 ), STAT=AS ) ! UAJ
